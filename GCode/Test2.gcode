...
;Printed @ about 0.20mm Z height, default settings

T0                               ; Select tool 0

M140 S45                         ; Set the bed temperature to 45 degrees Celsius
M105                             ; Report the current temperature of the extruder and bed
M190 S45                         ; Wait for the bed to reach 45 degrees Celsius before continuing
M104 S245                        ; Set the extruder temperature to 245 degrees Celsius
M105                             ; Report the current temperature of the extruder and bed
M109 S245                        ; Wait for the extruder to reach 245 degrees Celsius before continuing
